...
describe('generateHourlyWeather', () => {
    it('should to create correct link', () => {
        ...
        expect(result).toBe('https://api.openweathermap.org/data/2.5/forecast?lat=51.5074&lon=-0.1278&appid=your_api_token')
    })
    ...
    it('should work correctly with negative latitude and longitude values', () => {
        ...
        expect(result).toBe('https://api.weatherapi.com/v1/forecast?lat=-34.6037&lon=-58.3816&appid=your_api_token')
    })
